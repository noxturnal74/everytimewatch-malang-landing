...
const bannedTerms = [["Laya","nan"],["Pa","ket"],["Kon","tak"],["Kota"," Malang"]].map((parts) => parts.join(""));
...
if (!js.includes("requestAnimationFrame") || !js.includes('motionProfile = "watch"') || !html.includes('data-motion-profile="watch"')) {
...
console.log("Everytimewatch brand-DNA build check passed.");
